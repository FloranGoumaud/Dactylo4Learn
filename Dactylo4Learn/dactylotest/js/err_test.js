...
function err_test()
{
  ...
  for (i=0;i<list_f.length;i++)
  {
    ...
    if (a!=b)
    {
      document.getElementById("car"+a.length).style.color = "#f02c34";
      document.getElementById("car"+a.length).style.backgroundColor = "#f02c34";
...
function err_test_txt()
{
  ...
  for (i=0;i<list_f.length;i++)
  {
    ...
    if (a!=b)
    {
      ...
      {
        err_progress = true;       
        a='<span style="color:#f02c34">'+a+'</span>';
        document.getElementById("resultats").innerHTML+= i+" "+b+'<br/>'+i+" "+a+'<br/><br/>';
